      ...
      <nav id="mainNav">
        ...
        >
          <svg
            ...
            className="nav-icon"
            style={{
              fill: currentPage === "missions" ? ACTIVE_ICON_FILL : undefined,
            }}
          >
        ...
        >
          <svg
            ...
            className="nav-icon"
            style={{
              fill: currentPage === "nfts" ? ACTIVE_ICON_FILL : undefined,
            }}
          >
        ...
        >
          <svg
            ...
            className="nav-icon"
            style={{
              fill: currentPage === "rentals" ? ACTIVE_ICON_FILL : undefined,
            }}
          >
        ...
        >
          <svg
            ...
            className="nav-icon"
            style={{
              fill: currentPage === "mish_tish" ? ACTIVE_ICON_FILL : undefined,
            }}
          >
        ...
        >
          <svg
            ...
            className="nav-icon"
            style={{
              fill: currentPage === "stats" ? ACTIVE_ICON_FILL : undefined,
            }}
          >
        ...
        >
          ...
          >
            <path d="M71.5 169L54.5 152L88.4 118.1L105.4 135.1L273.4 303.1L290.4 320.1L273.4 337.1L105.4 505.1L88.4 522.1L54.5 488.2L71.5 471.2L222.5 320.2L71.5 169.2zM280.5 464L576.5 464L576.5 512L256.5 512L256.5 464L280.5 464z" />
          </svg>
          CLI
        </button>
        <a
        ...
        >
          <svg
            ...
            className="nav-icon"
            style={{
              fill: currentPage === "settings" ? ACTIVE_ICON_FILL : undefined,
            }}
          >
        ...
        {debugPageVisible ? (
          ...
          >
            <svg
              ...
              className="nav-icon"
              style={{
                fill: currentPage === "debug" ? ACTIVE_ICON_FILL : undefined,
              }}
            >
